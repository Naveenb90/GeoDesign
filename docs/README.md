...
| File | Description |
|------|-------------|
| **[ASTRO_MIGRATION.md](./ASTRO_MIGRATION.md)** | Astro at repo root, Netlify, layout map |
| **[PROJECT_SUMMARY.md](./PROJECT_SUMMARY.md)** | Routes, key files, scripts, deployment |
...
Copy `git-local.example.md` to **`git-local.md`** in this folder. **`docs/git-local.md`** is listed in **`.gitignore`** so you can store fork URLs or personal reminders without committing them.
